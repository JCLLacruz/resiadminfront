import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Container, Divider, Heading, Spinner, Text } from '@chakra-ui/react';
...
const ActivityView: FC = () => {
    ...
    return (
        <Container maxW='container.xl' padding={'2rem'} width={'100%'}>
            <Heading  size={'3xl'}mb={'2rem'}>{activity?.title}</Heading>
            <Text mb={'1rem'}>Descripción de la actividad:</Text>
            <Text mb={'1rem'} paddingLeft={'1rem'}>{activity?.description}</Text>
            <Text>Sesiones:</Text>
